...
Three worked notebooks, each running in your browser the same way. They pick up
where the :doc:`guide` leaves off: the guide says what the API does, these ask
what to do with it.
